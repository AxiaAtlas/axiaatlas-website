...
export const metadata: Metadata = {
  title: 'Client Case Studies and Marketing Results',
  description: DESCRIPTION,
  alternates: { canonical: '/case-studies' },
  ...social({ title: pageTitle('Client Case Studies and Marketing Results'), description: DESCRIPTION, path: '/case-studies' }),
}
  ...
  return (
    <div className="page cs-page">
      <div className="cs-hero">
        ...
        <h1 className="section-headline">Real Client Case Studies<br />With Measured Marketing Results</h1>
        <p className="section-sub">We keep client names confidential. The numbers speak for themselves.</p>
      </div>

      <div className="cs-slider-wrap">
        <CaseSlider cases={cases as any} />
      </div>
