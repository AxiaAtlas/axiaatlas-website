...
const PLACEHOLDERS = [
  ...
  },
  {
    ...
    challenge: 'Leaning hard on paid ads to grow, with generic, inconsistent social that did little for organic discovery.',
    approach: 'Repositioned the brand voice, built a content-pillar framework, and went carousel-first on Instagram so every post earned reach on its own.',
    result_headline: '2.4× ROAS in 60 days',
    result_detail: 'Organic reach climbed sharply, the email list grew off content CTAs, and the organic data sharpened the ad creative — lifting return on every dollar spent.',
    service_used: 'Social Media + Content',
  },
  {
    id: '3',
    industry: 'E-commerce',
